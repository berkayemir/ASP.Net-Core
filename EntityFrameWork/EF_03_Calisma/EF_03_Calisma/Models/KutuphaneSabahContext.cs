...
namespace EF_03_Calisma.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitaplar>(entity =>
            {
                entity.HasKey(e => e.Isbn)
                    .HasName("PK__Kitaplar__447D36EB93A33F1F");
                ...
                entity.HasOne(d => d.Tur)
                    ...
                    .HasConstraintName("FK__Kitaplar__TurID__2F10007B");
                ...
                entity.HasOne(d => d.Yazar)
                    ...
                    .HasConstraintName("FK__Kitaplar__YazarI__300424B4");
            });
            ...
            modelBuilder.Entity<Odunc>(entity =>
            {
                ...
                entity.HasOne(d => d.KitapIsbnNavigation)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Odunc__KitapISBN__34C8D9D1");
            ...
            modelBuilder.Entity<Turler>(entity =>
            {
                ...
                entity.HasIndex(e => e.TurAd, "UQ__Turler__A1D0193D188783E2")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yayinevleri>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ad, "UQ__Yayinevl__3214AD009DCDA2BC")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yazarlar>(entity =>
            {
                ...
                entity.HasOne(d => d.Tur)
                    ...
                    .HasForeignKey(d => d.TurId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__Yazarlar__TurID__276EDEB3");
            });
