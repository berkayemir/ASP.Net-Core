...
namespace EF_2504.DAL.Concrete.EF
{
    public class BookAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Toplu Halde buraya modelBuilder ekleme komutu
            //Var olan configlerimizden herhangi birini seçip onun tipini alıyor ve
            //o tipteki tüm configlerin uygulanmasını sağlıyor.
